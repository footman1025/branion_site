  ...
  return (
    <footer className="footer">
      <div className="container footer-inner">
        <div className="footer-brand">
          <Link to="/" className="logo-footer">
            <img src={logo} alt="Bravio" style={{ height: '36px', width: 'auto', objectFit: 'contain' }} />
          </Link>
          <p>{f.desc}</p>
        </div>
        ...
        <div className="footer-links">
          <h4>{f.contact}</h4>
          <ul>
            <li><a href="mailto:support@Bravio.com">support@Bravio.com</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        <p>© {year} Bravio LLC. All Rights Reserved.</p>
        ...
        <div className="footer-socials-bottom">
          <a href="https://linkedin.com/company/Bravio" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="fsb-icon">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
          </a>
          <a href="https://x.com/Bravio" target="_blank" rel="noopener noreferrer" aria-label="X / Twitter" className="fsb-icon">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
          </a>
          <a href="https://youtube.com/Bravio" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="fsb-icon">
