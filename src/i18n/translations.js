export const translations = {
  en: {
    ...
    aboutPage: {
      ...
      missionP1: 'Founded in 2023, DefiGate was born from a simple belief: the best blockchain products are built by teams who understand both the technology and the business.',
  ...
  es: {
    ...
    aboutPage: {
      ...
      missionP1: 'Fundada en 2018, DefiGate ha crecido de un pequeño equipo de ingenieros apasionados a una empresa global con clientes en más de 30 países.',
    ...
    auth: {
      welcomeBack: 'Bienvenido de nuevo', signInSub: 'Inicia sesión en tu cuenta DefiGate',
      signIn: 'Iniciar Sesión', signingIn: 'Iniciando sesión...',
      createAccount: 'Crear cuenta', joinSub: 'Únete a DefiGate hoy',
  ...
  fr: {
    ...
    aboutPage: {
      ...
      subtitle: 'DefiGate est une société mondiale de développement logiciel.',
      missionTag: 'Notre Mission', missionTitle: 'Transformer des idées complexes en logiciels élégants et évolutifs',
      missionP1: 'Fondée en 2018, DefiGate est passée d\'une petite équipe d\'ingénieurs passionnés à une entreprise mondiale avec des clients dans plus de 30 pays.',
    ...
    auth: {
      welcomeBack: 'Bon retour', signInSub: 'Connectez-vous à votre compte DefiGate',
      signIn: 'Se Connecter', signingIn: 'Connexion en cours...',
      createAccount: 'Créer un compte', joinSub: 'Rejoignez DefiGate aujourd\'hui',
    ...
    footer: {
      ...
      rights: '© {year} DefiGate. Tous droits réservés.',
    },
    cookie: {
  ...
  nl: {
    ...
    aboutPage: {
      ...
      missionP1: 'Opgericht in 2018, is DefiGate gegroeid van een klein team van gepassioneerde ingenieurs naar een wereldwijd bedrijf met klanten in meer dan 30 landen.',
  ...
  pt: {
    ...
    aboutPage: {
      ...
      subtitle: 'DefiGate é uma empresa global de desenvolvimento de software.',
      missionTag: 'Nossa Missão', missionTitle: 'Transformando ideias complexas em software elegante e escalável',
      missionP1: 'Fundada em 2018, a DefiGate cresceu de uma pequena equipe de engenheiros apaixonados para uma empresa global com clientes em mais de 30 países.',
    ...
    auth: {
      ...
      createAccount: 'Criar conta', joinSub: 'Junte-se à DefiGate hoje',
  ...
  it: {
    ...
    aboutPage: {
      ...
      subtitle: 'DefiGate è una società globale di sviluppo software.',
      missionTag: 'La Nostra Missione', missionTitle: 'Trasformare idee complesse in software elegante e scalabile',
      missionP1: 'Fondata nel 2018, DefiGate è cresciuta da un piccolo team di ingegneri appassionati a un\'azienda globale con clienti in oltre 30 paesi.',
