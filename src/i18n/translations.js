export const translations = {
  en: {
    ...
    hero: {
      ...
      title2: 'EVOLVE.',
      sub: 'At Bravion, we combine blockchain and AI to power the future of e-commerce. Our solutions deliver transparency, security, and efficiency, creating a seamless digital experience for businesses and consumers alike.',
    ...
    aboutPage: {
      ...
      subtitle: 'Bravio is a blockchain product company building the infrastructure that powers the next generation of decentralized finance and Web3 applications.',
      missionTag: 'Our Mission', missionTitle: 'Making blockchain infrastructure accessible, secure, and production-ready',
      missionP1: 'Founded in 2023, Bravio was born from a simple belief: the best blockchain products are built by teams who understand both the technology and the business.',
    ...
    auth: {
      welcomeBack: 'Welcome back', signInSub: 'Sign in to your Bravio account',
      signIn: 'Sign In', signingIn: 'Signing in...',
      createAccount: 'Create account', joinSub: 'Join Bravio today',
    ...
    footer: {
      desc: 'Bravio builds production-grade blockchain infrastructure — DeFi protocols, smart contract platforms, Web3 wallets, and on-chain analytics.',
      ...
      rights: '© {year} Bravio. All rights reserved.',
    },
    cookie: {
  ...
  es: {
    ...
    aboutPage: {
      ...
      subtitle: 'Bravio es una empresa global de desarrollo de software.',
      missionTag: 'Nuestra Misión', missionTitle: 'Convirtiendo ideas complejas en software elegante y escalable',
      missionP1: 'Fundada en 2018, Bravio ha crecido de un pequeño equipo de ingenieros apasionados a una empresa global con clientes en más de 30 países.',
    ...
    auth: {
      welcomeBack: 'Bienvenido de nuevo', signInSub: 'Inicia sesión en tu cuenta Bravio',
      signIn: 'Iniciar Sesión', signingIn: 'Iniciando sesión...',
      createAccount: 'Crear cuenta', joinSub: 'Únete a Bravio hoy',
    ...
    footer: {
      ...
      rights: '© {year} Bravio. Todos los derechos reservados.',
    },
    cookie: {
  ...
  fr: {
    ...
    aboutPage: {
      ...
      subtitle: 'Bravio est une société mondiale de développement logiciel.',
      missionTag: 'Notre Mission', missionTitle: 'Transformer des idées complexes en logiciels élégants et évolutifs',
      missionP1: 'Fondée en 2018, Bravio est passée d\'une petite équipe d\'ingénieurs passionnés à une entreprise mondiale avec des clients dans plus de 30 pays.',
    ...
    auth: {
      welcomeBack: 'Bon retour', signInSub: 'Connectez-vous à votre compte Bravio',
      signIn: 'Se Connecter', signingIn: 'Connexion en cours...',
      createAccount: 'Créer un compte', joinSub: 'Rejoignez Bravio aujourd\'hui',
    ...
    footer: {
      ...
      rights: '© {year} Bravio. Tous droits réservés.',
    },
    cookie: {
  ...
  nl: {
    ...
    aboutPage: {
      ...
      subtitle: 'Bravio is een wereldwijd softwareontwikkelingsbedrijf.',
      missionTag: 'Onze Missie', missionTitle: 'Complexe ideeën omzetten in elegante, schaalbare software',
      missionP1: 'Opgericht in 2018, is Bravio gegroeid van een klein team van gepassioneerde ingenieurs naar een wereldwijd bedrijf met klanten in meer dan 30 landen.',
    ...
    auth: {
      welcomeBack: 'Welkom terug', signInSub: 'Log in op uw Bravio-account',
      signIn: 'Inloggen', signingIn: 'Inloggen...',
      createAccount: 'Account aanmaken', joinSub: 'Word vandaag lid van Bravio',
    ...
    footer: {
      ...
      rights: '© {year} Bravio. Alle rechten voorbehouden.',
    },
    cookie: {
  ...
  pt: {
    ...
    aboutPage: {
      ...
      subtitle: 'Bravio é uma empresa global de desenvolvimento de software.',
      missionTag: 'Nossa Missão', missionTitle: 'Transformando ideias complexas em software elegante e escalável',
      missionP1: 'Fundada em 2018, a Bravio cresceu de uma pequena equipe de engenheiros apaixonados para uma empresa global com clientes em mais de 30 países.',
    ...
    auth: {
      welcomeBack: 'Bem-vindo de volta', signInSub: 'Entre na sua conta Bravio',
      signIn: 'Entrar', signingIn: 'Entrando...',
      createAccount: 'Criar conta', joinSub: 'Junte-se à Bravio hoje',
    ...
    footer: {
      ...
      rights: '© {year} Bravio. Todos os direitos reservados.',
    },
    cookie: {
  ...
  it: {
    ...
    aboutPage: {
      ...
      subtitle: 'Bravio è una società globale di sviluppo software.',
      missionTag: 'La Nostra Missione', missionTitle: 'Trasformare idee complesse in software elegante e scalabile',
      missionP1: 'Fondata nel 2018, Bravio è cresciuta da un piccolo team di ingegneri appassionati a un\'azienda globale con clienti in oltre 30 paesi.',
    ...
    auth: {
      welcomeBack: 'Bentornato', signInSub: 'Accedi al tuo account Bravio',
      signIn: 'Accedi', signingIn: 'Accesso in corso...',
      createAccount: 'Crea account', joinSub: 'Unisciti a Bravio oggi',
    ...
    footer: {
      ...
      rights: '© {year} Bravio. Tutti i diritti riservati.',
    },
    cookie: {
